...
def run_DQN():
    ...
    # =============================================================================
            ...
            expected_state_action_values = (next_state_values.max(1)[0].view(self.BATCH_SIZE, 1) * self.GAMMA) + reward_batch # alpha(R_t+gamma*maxQ)
            loss = F.smooth_l1_loss(0.95*state_action_values, 0.05*expected_state_action_values)
